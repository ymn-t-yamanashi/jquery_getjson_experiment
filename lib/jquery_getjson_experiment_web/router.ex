defmodule JqueryGetjsonExperimentWeb.Router do
  use JqueryGetjsonExperimentWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {JqueryGetjsonExperimentWeb.Layouts, :root}
  ...
  if Application.compile_env(:jquery_getjson_experiment, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: JqueryGetjsonExperimentWeb.Telemetry
